...
& $tools.ClExe glfw_uwp.cpp /LD /EHsc /std:c++17 $CommonClFlags /O2 /GL /Gw /arch:AVX2 /DNDEBUG /D_UNICODE /DUNICODE /D_WIN32_WINNT=0x0A00 /D_SILENCE_EXPERIMENTAL_COROUTINE_DEPRECATION_WARNINGS /Fo"$objPath" `
